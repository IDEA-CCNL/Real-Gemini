...
class Text2Box(object):
    ...
    _description_="""当你只想检测或者找出图片中的某个物体时很有用。输入到这个工具的应该是一个被逗号分隔成两部分的字符串，分别表示图片的路径或者图片所在的文件夹路径和要检测的物体。
    ...
    def inference(self, inputs):
        try:
            ...
            return "Please input the image_dir and the object to be detected, separated by comma"
